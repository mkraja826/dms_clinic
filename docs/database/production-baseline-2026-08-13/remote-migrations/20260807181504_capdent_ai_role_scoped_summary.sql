drop function if exists public.get_capdent_ai_today_summary();

create function public.get_capdent_ai_today_summary()
returns table(
  clinic_name text,
  currency_code text,
  local_date date,
...
begin
  ...
  select
    ...
    case when v_can_view_finance then coalesce((
