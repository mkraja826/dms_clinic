  ...
  return (
    <Screen bottomBar={<WorkflowBottomNav items={headWorkflowNavItems} activeKey="more" />}>
      ...
      <ToolSection title="Admin">
        ...
        <ToolRow title="Restore Subscription" subtitle="Recover a verified Google Play plan after reinstall or device change" icon="refresh-circle-outline" target="/settings/restore-subscription" />
